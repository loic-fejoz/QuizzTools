...
/**
 * Entry point of the 'ExportToHtml' generation module.
 * 
...
public class ExportToHtml {
    ...
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      templateURL = FileLocator.toFileURL(ExportToHtml.class.getResource(MODULE_FILE_NAME + ".emtl"));
    } else {
      templateURL = ExportToHtml.class.getResource(MODULE_FILE_NAME + ".emtl");
    }
    if (templateURL == null) {
	 ...
	 * @generated
	 */
	public ExportToHtml(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        ExportToHtml generator = new ExportToHtml(modelURI, folder, arguments);
