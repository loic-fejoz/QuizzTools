...
/**
 * Entry point of the 'ExportToJson' generation module.
 * 
...
public class ExportToJson {
	 ...
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "exportToJson";
	
	/**
	 * The name of the templates that are to be generated.
	 * @generated NOT
	 */
	public static final String TEMPLATE_NAMES = "export";
	 ...
	 * @generated
	 */
	public ExportToJson(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ResourceSet resourceSet = new ResourceSetImpl();
    registerResourceFactories(resourceSet);
    registerPackages(resourceSet);
    final URL templateURL;
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      templateURL = FileLocator.toFileURL(ExportToJson.class.getResource(MODULE_FILE_NAME + ".emtl"));
    } else {
      templateURL = ExportToJson.class.getResource(MODULE_FILE_NAME + ".emtl");
    }
    if (templateURL == null) {
	 ...
	 * @generated
	 */
	public ExportToJson(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        ExportToJson generator = new ExportToJson(modelURI, folder, arguments);
    ...
    if (!targetFolder.exists()) {
      ...
      AcceleoService.doGenerate(module, TEMPLATE_NAMES, model, arguments, targetFolder, false, monitor);
  }
