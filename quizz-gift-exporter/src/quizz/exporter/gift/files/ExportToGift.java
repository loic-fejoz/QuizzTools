 ...
 *******************************************************************************/
package quizz.exporter.gift.files;
...
/**
 * Entry point of the 'ExportToGift' generation module.
 * 
 * @author <a href="mailto:jonathan.musset@obeo.fr">Jonathan Musset</a>
 */
public class ExportToGift {

	/**
	 * The name of the module.
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "exportToGift";
	 ...
	 * @generated
	 */
	public ExportToGift(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ResourceSet resourceSet = new ResourceSetImpl();
    registerResourceFactories(resourceSet);
    registerPackages(resourceSet);
    final URL templateURL;
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      templateURL = FileLocator.toFileURL(ExportToGift.class.getResource(MODULE_FILE_NAME + ".emtl"));
    } else {
      templateURL = ExportToGift.class.getResource(MODULE_FILE_NAME + ".emtl");
    }
    if (templateURL == null) {
	 ...
	 * @generated
	 */
	public ExportToGift(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        ExportToGift generator = new ExportToGift(modelURI, folder, arguments);
